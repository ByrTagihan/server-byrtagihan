...
public class Bill extends DateConfig {
    ...
    public Bill(Long id, String description, Long member_id, Long organization_id, Date periode, Double amount, Long paid_id, Date paid_date, Long payment_id, Double paid_amount) {
        this.id = id;
